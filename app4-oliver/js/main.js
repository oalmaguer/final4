...
function onDeviceReady(){
	...
	document.getElementById("openlink").addEventListener('click', boton);
...
function queryDBDeleteForm(tx){
	...
	tx.executeSql("DELETE FROM agenda_curso (nombre,apellidos,telefono,categoria,foto,email,nota,pweb) VALUES ('"+$("#ti_nombre").val()+"','"+$("#ti_apellidos").val()+"','"+$("#ti_telefono").val()+"','"+cat+"','"+$.imageURL+"','"+$("#ti_mail").val()+"','"+$("#ti_nota").val()+"','"+$("#ti_pweb").val()+"')", [], newFormSuccess, errorDB);
}
